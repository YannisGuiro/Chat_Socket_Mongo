...
socket.on('connect', data => {
    ...
    socket.on('response-list-user', ({listUsers, name}) => {
        ...
        let el = document.querySelector('[id="welcome"').querySelector('span')
        el.innerHTML = name; 
    });
    ...
    socket.on('hide message', ({ messageId, roomId }) => {
        if (actualRoom == roomId) {
            ...
            el = document.querySelector('[class="msg"][value="' + messageId + '"]').querySelector('video')
            if(el) el.parentElement.removeChild(el);
            el = document.querySelector('[class="msg"][value="' + messageId + '"]').querySelector('img')
            if(el) el.parentElement.removeChild(el);
            el = document.querySelector('[class="msg"][value="' + messageId + '"]').querySelector('audio')
            if(el) el.parentElement.removeChild(el);
